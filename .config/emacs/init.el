...
(let ((bootstrap-file
  ...
  (use-package auto-package-update
    ...
    (set-face-attribute 'default nil :font "JetBrains Mono" :height guto/default-font-size)
    ;; Set the fixed pitch face
    (set-face-attribute 'fixed-pitch nil :font "JetBrains Mono" :height guto/default-font-size)
