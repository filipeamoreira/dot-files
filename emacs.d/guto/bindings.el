...
;; F5: Org functions
;;-----------------------------------------------------------------------------
;;(global-set-key (kbd "<f5> a")  org-toggle-archive-tag)
;; (global-set-key (kbd "<f5> b")  org-ido-switchb)
;; (global-set-key (kbd "<f5> i")  org-clock-in)
;; (global-set-key (kbd "<f5> o")  org-clock-out)
;; (global-set-key (kbd "<f5> r")  org-refile)
;; (global-set-key (kbd "<f5> f")  org-occur)
;(global-set-key (kbd "<f5> r")  org-remember)
;; (global-set-key (kbd "<f5> v")  org-archive-subtree)
;; (global-set-key (kbd "<f5> t")  my-org-todo)
;; (global-set-key (kbd "<f5> w")  widen)
;; (global-set-key (kbd "<f5> u")  org-feed-update-all)
;;-----------------------------------------------------------------------------
;; F6: Emacs functions
;;-----------------------------------------------------------------------------
