...
(defvar guto-keybinds-minor-mode-map
...
(guto-bindings-minor-mode 1)

(add-hook 'after-load-functions 'guto-bindings-have-priority)

(defun guto-bindings-have-priority (_file)
  "Try to ensure my personal key bindings retain precedence over other minor modes.
Called via the `after-load-functions` special hook."
  (unless (eq (caar minor-mode-map-alist) 'guto-bindings-minor-mode)
    (let ((mykeys (assq 'guto-bindings-minor-mode minor-mode-map-alist)))
      (assq-delete-all 'guto-bindings-minor-mode minor-mode-map-alist)
