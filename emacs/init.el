...
(defvar guto/default-font-size 200)
(defvar guto/default-variable-font-size 200)
...
(defun guto/org-font-setup ()
  ...
  (dolist (face '((org-level-1 . 1.2)
                  ...
                  (org-level-7 . 1.1)
                  (org-level-8 . 1.1)))
    (set-face-attribute (car face) nil :font "Source Sans 3 VF-18" :weight 'regular :height (cdr face)))
...
(defun guto/org-babel-tangle-config ()
...
(add-hook 'org-mode-hook (lambda () (add-hook 'after-save-hook #'guto/org-babel-tangle-config)))
